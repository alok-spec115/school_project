...
insert into UT1 values(1254,01,'AJAY',
insert into UT1 values(1255,02,'RAKESH',
insert into UT1 values(1256,03,'RAMESH',
insert into UT1 values(1257,04,'HARDIK',
insert into UT1 values(1258,05,'PRANJAL',
create table ut2(
SRNO int4 primary key,
RNO int2,
NAME VARCHAR(20) not null,
